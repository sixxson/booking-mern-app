        ...
        <div className="grid grid-cols-1 xl:grid-cols-[2fr_3fr] border border-slate-300 rounded-lg p-8 gap-8">
            ...
            <div className="grid grid-rows-[1fr_2fr_3fr]">
                ...
                <div className="grid grid-cols-2 items-end whitespace-nowrap">
                    <div className="flex flex-wrap lg:flex-row gap-1 items-center">
                    ...
                    <div className="flex flex-col items-end gap-1">
                        ...
                        <Link to={`/detail/${hotel._id}`} className="bg-blue-600 rounded-md text-white h-full p-2 font-bold text-xl max-w-fit hover:bg-blue-500">
                            View More
                        </Link>
                    </div>
                </div>
